...
class MemoryManager:
    ...
    def __init__(self, max_folds: int = 3):
        self.factual_memory: Dict[Tuple[str, str], FactualEntry] = {}
        self.procedural_memory: List[ProceduralNode] = []
        self.experiential_memory: Dict[str, ExperientialHeuristic] = {}

        self.factual_memories: List[str] = []
        self.procedural_memories: Optional[str] = None
        self.experiential_memories: Optional[str] = None
