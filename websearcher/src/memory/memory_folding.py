...
async def generate_factual_memory(
    ...
    instruction = get_factual_memory_instruction(question, prev_reasoning, tools_str)
...
async def generate_procedural_memory(
    ...
    """
    tools_str = json.dumps(available_tools or [], ensure_ascii=False)
    instruction = get_procedural_memory_instruction(question, prev_reasoning, tools_str)
...
async def generate_experiential_memory(
    ...
    instruction = get_experiential_memory_instruction(question, prev_reasoning, history_str, tools_str)
...
async def fold_memory(
    ...
    factual_task = (
        generate_factual_memory(
            ...
            available_tools, temperature, max_tokens
    ...
    experiential_task = (
        generate_experiential_memory(
            client, model_name, question, prev_reasoning,
            tool_call_history, available_tools, temperature, max_tokens
...
generate_episode_memory = generate_factual_memory
generate_working_memory = generate_procedural_memory
generate_tool_memory = generate_experiential_memory

# Legacy prompt functions
get_episode_memory_instruction = get_factual_memory_instruction
get_working_memory_instruction = get_procedural_memory_instruction
get_tool_memory_instruction = get_experiential_memory_instruction
